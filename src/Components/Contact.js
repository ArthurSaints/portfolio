...
const Contact = ({ data }) => {
  const [url, setUrl] = useState(
    "mailto:arthur.santos@muvy.me?subject=subject&body=body"
  );
  ...
  const handleClick = (e) => {
    e.preventDefault();
    window.open(
      `mailto:arthur.santos@muvy.me?subject=${subject}&body=${name}: ${message}`
    );
  };
      ...
      <div className='row'>
        <div className='eight columns'>
          ...
          <div id='message-success'>
            <i className='fa fa-check'></i>Sua mensagem foi enviado, obrigado!
            <br />
          </div>
        </div>
